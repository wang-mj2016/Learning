...
//		},
		...
		setx:function(pagex)
		{
				...
				currentTime = parseFloat((pagex-$("#hxaudio_line").offset().left) / n).toFixed(2);
				document.getElementById("NativeAudio").currentTime =  currentTime;
				myaudio = document.getElementById("NativeAudio");
				console.log('thisaudio===' +thisaudio.currentTime);
...
//			this.bindhtml();
		...
		addNativeAudio:function()
		{
			...
			document.getElementById("NativeAudio").onloadedmetadata = function(){
				_this.audioloaded();
				thisaudio = document.getElementById("NativeAudio");
			}
		}
	};
})();